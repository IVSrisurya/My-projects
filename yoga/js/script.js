	function openmenu(){
		...
		document.getElementById("navlist").style.width = "10%";
...
function myFunction2() {
	...
	var History = 1.15*width/1000
	var Vedic = 1.15*width/1000 
	var Glorious = 1.15*width/1000 
	var heritage = 1.15*width/1000
	var studntsproject = 1.15*width/1000 
	var amrlogo = 1.1*width/1000
	var footecont = 0.8*width/1000
...
function load_page(){
	var searchbtn = document.getElementById("searching").value + ".html"
	window.location.href = searchbtn;
}